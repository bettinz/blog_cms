...
class ReadyToPublishNewsValidateTest extends CommonFunctions
{
    ...
    public function testReadyToPublishNewsValidateAsEditor(): void
    {
        /**
         * @var News|null $news
         */
    ...
    public function testReadyToPublishNewsValidateAsPublisher(): void
    {
        /**
         * @var News|null $news
         */
    ...
    public function testReadyToPublishNewsValidateAsReviewer(): void
    {
        /**
         * @var News|null $news
         */
    ...
    public function testReadyToPublishNewsValidateAsAdmin(): void
    {
        /**
         * @var News|null $news
         */
