...
class PublishedNewsMoveToDraftsTest extends CommonFunctions
{
    ...
    public function testPublishedNewsMoveToDraftsAsEditor(): void
    {
        /**
         * @var News|null $news
         */
    ...
    public function testPublishedNewsMoveToDraftsAsPublisher(): void
    {
        /**
         * @var News|null $news
         */
    ...
    public function testPublishedNewsMoveToDraftsAsReviewer(): void
    {
        /**
         * @var News|null $news
         */
    ...
    public function testPublishedNewsMoveToDraftsAsAdmin(): void
    {
        /**
         * @var News|null $news
         */
